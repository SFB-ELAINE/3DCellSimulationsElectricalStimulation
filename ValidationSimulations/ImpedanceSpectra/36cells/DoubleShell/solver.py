...
mesh = load_mesh("doubleshellmesh.vol.gz", comm, curve_order=order)
printmaster("Done")
...
volume_ratio = ngsolve.Integrate(
    ...
    fes.mesh,
    definedon=fes.mesh.Materials("cytoplasm|nucleoplasm"),
)
...
conductivities = {"ecm": 1.0, "cytoplasm": 0.48, "nucleoplasm": 0.95}
permittivities = {"ecm": 80, "cytoplasm": 60, "nucleoplasm": 120}
...
for i, freq in enumerate(freqs):
    ...
    if parameters_changed:
        ...
        impedance = fes.compute_impedance(sig_at_freq, y_at_freq)
        # convert to Ohm
...
filename = "results/results_double_shell"
