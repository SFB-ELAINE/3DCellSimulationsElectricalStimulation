...
mesh = load_mesh("singleshellwallmesh.vol.gz", comm, curve_order=order)
printmaster("Done")
...
domains = ["ecm|pcm", "cytoplasm"]
interface_info = {"ecm|pcm": "membrane", "cytoplasm": "membrane"}
outer_inner_pairs = {"membrane": ("ecm|pcm", "cytoplasm")}
...
volume_ratio = ngsolve.Integrate(
    ...
    fes.mesh,
    definedon=fes.mesh.Materials("pcm|cytoplasm"),
)
...
conductivities = {"ecm": 1.0, "cytoplasm": 0.48, "pcm": 0.01}
permittivities = {"ecm": 80, "cytoplasm": 60, "pcm": 20}
...
filename = "results/results_single_shell_wall"
